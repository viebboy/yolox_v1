...
class Exp(MyExp):
    def __init__(self):
        ...
        # backbone params
        self.nb_init_filters = 36
        self.groups = 3
        self.stages = [4, 4, 3, 3]
        self.grow_rates = [2.0, 2.0, 3.0, 3.0]
        self.depth_in_fpn = 2
        # head params
        self.head_hidden_dim = 33
    ...
    def get_model(self, sublinear=False):
        ...
        if "model" not in self.__dict__:
            from yolox.models.yoloxv2 import YOLOX, YOLOPAFPN, YOLOXHead
            backbone = YOLOPAFPN(
    ...
    def get_deploy_model(self):
        ...
        from yolox.models.yoloxv2 import YOLOXDeploy, YOLOPAFPN, YOLOXHeadDeploy
        backbone = YOLOPAFPN(
            nb_init_filters=self.nb_init_filters,
            groups=self.groups,
            stages=self.stages,
